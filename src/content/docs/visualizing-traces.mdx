---
title: Visualizing Traces in Sentry
description: Master Sentry's trace visualization tools to debug performance issues and optimize your application
---

import { Steps } from '@astrojs/starlight/components';

Now that you have comprehensive instrumentation throughout your application, it's time to learn how to effectively use Sentry's visualization tools to analyze performance, debug issues, and optimize your application.

## Learning Objectives

By the end of this module, you will:

- Navigate Sentry's Performance and Trace views effectively
- Use filters and search to find specific issues
- Analyze waterfall charts and span details
