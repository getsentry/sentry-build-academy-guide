---
title: Understanding Database Queries
description: Learn to search for and leverage database query performance data in your Sentry spans
---

import { Steps } from '@astrojs/starlight/components';

Database performance is often the biggest bottleneck in web applications. In this module, you'll learn how to instrument database queries, analyze their performance in Sentry, and use this data to optimize your application.
