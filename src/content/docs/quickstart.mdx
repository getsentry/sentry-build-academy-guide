...
<Steps>
  ...
  4. **Set up environment variables**
     ...
     # Add PORT=3001 to specify the server port
  ...
  5. **Database Setup**
     ...
     ```bash
     # Setup a temporary NeonDB Postgres instance 
     pnpx neondb
     # Follow the prompts to set up the database ensure you use the .env for your Server directory

     # Setup our schema and seed the database 
     pnpm db:generate
     pnpm db:push
     pnpm db:import
     ```
